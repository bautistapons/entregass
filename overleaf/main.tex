...
\simpleheader{headercolour}{Bautista}{Pons}{Estudiante de Ingeniería Industrial (UNCuyo)}{white}
...
\flushright
\begin{center}
    \roundpic{BAUTIFOTO.jpg}
\end{center}

\bg{cvgreen}{white}{Sobre mi}\\[0.5em]

{Estudiante de Ingeniería Industrial en la Universidad Nacional de Cuyo, con formación en ciencias básicas. Me interesa la optimización de procesos y la mejora continua. Busco desarrollar experiencia práctica en entornos industriales, aplicando pensamiento analítico y resolución de problemas. }
\bigskip
...
• Análisis de datos ~•~ Optimización de procesos ~•~ Logística básica • Gestión de personas
...
\infobubble{\faAt}{cvgreen}{white}{baupons@gmail.com}


\infobubble{\faGithub}{cvgreen}{white}{bautistapons  }
...
\begin{tabular}{r| p{0.5\textwidth} c}
    \cvevent{2022- 3° año}{Estudios en curso}{UNCuyo}{\color{cvred}}{Ingeniería Industrial — Facultad de Ingeniería }{disney.png} \\
